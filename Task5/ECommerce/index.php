...
$productsOrderedResult = $products->mostOrderedProducts();
if ($productsResult) {
						...
						<div class="col-3">
							<div class="product-wrapper mb-30 w-100 h-100">
								<div class="product-img w-100 h-75">
									<a href="product-details.html">
										<img alt="" class="w-100 h-100" src="assets/img/product/<?=$product['img']?>">
									</a>
									<span>-30%</span>
									<div class="product-action">
										<a class="action-wishlist" href="#" title="Wishlist">
	...
	<div class="container">
		...
		<div class="tab-content jump">
			<div class="tab-pane active">
				<div class="row w-100 h-100">
					<?php
					foreach ($productsRatedData as $index => $productRated) { ?>
						<div class="col-3">
							<div class="product-wrapper mb-30 w-100 h-100">
								<div class="product-img w-100 h-75">
									<a href="product-details.html">
	...
	<div class="container">
		...
		<div class="tab-content jump">
			<div class="tab-pane active">
				<div class="row w-100 h-100">
					<?php
					foreach ($productsOrderedData as $index => $productOrdered) { ?>
						<div class="col-3">
							<div class="product-wrapper mb-30 w-100 h-100">
								<div class="product-img w-100 h-75">
									<a href="product-details.html">
										<img alt="" class="w-100 h-100" src="assets/img/product/<?=$productOrdered['img']?>">
									</a>
									<span>-30%</span>
									<div class="product-action">
										<a class="action-wishlist" href="#" title="Wishlist">
								...
								<div class="product-content text-left">
									<div class="product-hover-style">
										<div class="product-title">
											<h4>
												<a href="product-details.html"><?=$productOrdered['name_en']?></a>
											</h4>
										</div>
										<div class="cart-hover">
											<h4><a href="product-details.html">+ Add to cart</a></h4>
									...
									<div class="product-price-wrapper">
										<span><?=$productOrdered['price']?></span>
									</div>
								</div>
							</div>
						</div>
